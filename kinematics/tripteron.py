...
class TripteronKinematics:
    def __init__(self, toolhead, config):
        ...
        # Set the slow_xy2 and very_slow_xy2 attributes ### FOR HOMING
        self.max_xy2 = min(print_radius, radius) ** 2  # Ensure max_xy2 is squared
        self.slow_xy2 = 0.5 * self.max_xy2  # Set this to half of the max XY squared distance
        self.very_slow_xy2 = 0.25 * self.max_xy2  # Set this to a quarter of the max XY squared distance
        #print("slow_xy2 initialized to:", self.slow_xy2)
    ...
    def check_move(self, move):
        ...
        if end_xy2 > limit_xy2 or end_z > self.max_z or end_z < self.min_z:
            if (end_pos[:2] != self.home_position[:2] or
                end_z < self.min_z or end_z > self.home_position[2]):
        ...
        # Limit the speed/accel of this move if it is at the extreme end of the build envelope
